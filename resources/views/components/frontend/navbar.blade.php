      ...
      <div class="flex flex-stretch items-center">
        ...
        <div class="w-auto">
          ...
          >
            ...
            @auth
            <li class="mx-3 py-6 md:py-0">
              <a href="{{ route('dashboard.index')}}" class="text-black{{\Route::current()->getName() == 'Dashboard' ? 'md:text-white' :'md:text-black'}} hover:underline"
                >Dashboard</a
              >
            </li>
            @endauth
            @guest
            <li class="mx-3 py-6 md:py-0">
              <a href="{{ route('login')}}" class="text-black{{\Route::current()->getName() == 'Dashboard' ? 'md:text-white' :'md:text-black'}} hover:underline"
                >Login</a
              >
            </li>   <li class="mx-3 py-6 md:py-0">
              <a href="{{ route('register')}}" class="text-black{{\Route::current()->getName() == 'Dashboard' ? 'md:text-white' :'md:text-black'}} hover:underline"
                >Register</a
              >
            </li>
            @endguest
